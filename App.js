...
const SWIPER_DATA = [
  {
    ...
    title: 'Hayvonlar uchun hammasi bir joyda',
    subtitle: 'Hayvonlar, oziq-ovqat, mahsulotlar, veterinariya xizmatlari va AI maslahatlar — barchasi Zoovita\'da.',
  },
  {
    id: 2,
    image: require('./assets/swiper2.png'),
    title: 'Tezkor veterinariya yordami',
    subtitle: 'Eng malakali shifokorlar bilan maslahat va tezkor uchrashuvlarni belgilash xizmati.',
  },
  {
    id: 3,
    image: require('./assets/swiper3.png'),
    title: 'AI Smart-Maslahatchi',
    subtitle: 'Hayvonlaringizning holati, oziqlanishi va parvarishi bo\'yicha sun\'iy intellektdan tezkor maslahat oling.',
  },
];
...
// Categories Screen structured data
const CAT_SECTIONS = [
  {
    id: 'animals',
    title: 'Hayvonlar',
    ...
    iconColor: '#3C8E2D',
    items: [
      { id: 101, name: 'Qoramol', count: '156 e\'lon', image: 'https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?q=80&w=150&auto=format&fit=crop' },
      { id: 102, name: 'Qo\'y', count: '89 e\'lon', image: 'https://images.unsplash.com/photo-1484557985045-edf25e08da73?q=80&w=150&auto=format&fit=crop' },
      { id: 103, name: 'Otlar', count: '112 e\'lon', image: 'https://images.unsplash.com/photo-1553284965-83fd3e82fa5a?q=80&w=150&auto=format&fit=crop' },
      { id: 104, name: 'Echkilar', count: '74 e\'lon', image: 'https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d?q=80&w=150&auto=format&fit=crop' },
      { id: 105, name: 'Parrandalar', count: '203 e\'lon', image: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?q=80&w=150&auto=format&fit=crop' },
      { id: 106, name: 'Kemiruvchilar', count: '56 e\'lon', image: 'https://images.unsplash.com/photo-1585110396000-c9ffd4e4b308?q=80&w=150&auto=format&fit=crop' },
      { id: 107, name: 'Baliqlar', count: '38 e\'lon', image: 'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?q=80&w=150&auto=format&fit=crop' },
      { id: 108, name: 'Asalarilar', count: '12 e\'lon', image: 'https://images.unsplash.com/photo-1473081556163-2a17de81fc97?q=80&w=150&auto=format&fit=crop' },
      { id: 109, name: 'Boshqa hayvonlar', count: '27 e\'lon', image: 'https://images.unsplash.com/photo-1591024444444-4f8101a1c97a?q=80&w=150&auto=format&fit=crop' },
      { id: 110, name: 'It va mushuklar', count: '91 e\'lon', image: 'https://images.unsplash.com/photo-1517849845537-4d257902454a?q=80&w=150&auto=format&fit=crop' },
    ]
  },
  {
    id: 'products',
    ...
    iconColor: '#F5A623',
    items: [
      { id: 201, name: 'Oziq-ovqatlar', count: '120 mahsulot', image: 'https://images.unsplash.com/photo-1589927986089-35812388d1f4?q=80&w=150&auto=format&fit=crop' },
      { id: 202, name: 'Vitaminlar va qo\'shimchalar', count: '85 mahsulot', image: 'https://images.unsplash.com/photo-1611926653458-09294b3142bf?q=80&w=150&auto=format&fit=crop' },
      { id: 203, name: 'Parvarish mahsulotlari', count: '64 mahsulot', image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?q=80&w=150&auto=format&fit=crop' },
      { id: 204, name: 'Aksessuarlar', count: '72 mahsulot', image: 'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?q=80&w=150&auto=format&fit=crop' },
      { id: 205, name: 'Boshqa mahsulotlar', count: '43 mahsulot', image: 'https://images.unsplash.com/photo-1608454504242-a40f5e700be0?q=80&w=150&auto=format&fit=crop' },
    ]
  },
  {
    id: 'services',
    ...
    iconColor: '#1E88E5',
    items: [
      { id: 301, name: 'Veterinariya xizmatlari', count: '45 xizmat', image: 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?q=80&w=150&auto=format&fit=crop' },
      { id: 302, name: 'Grooming xizmatlari', count: '18 xizmat', image: 'https://images.unsplash.com/photo-1516734212186-a967f81ad0d7?q=80&w=150&auto=format&fit=crop' },
      { id: 303, name: 'Transport xizmatlari', count: '27 xizmat', image: 'https://images.unsplash.com/photo-1532601224476-15c79f2f7a51?q=80&w=150&auto=format&fit=crop' },
      { id: 304, name: 'Sun\'iy urug\'lantirish', count: '13 xizmat', image: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?q=80&w=150&auto=format&fit=crop' },
      { id: 305, name: 'Boshqa xizmatlar', count: '16 xizmat', image: 'https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?q=80&w=150&auto=format&fit=crop' },
    ]
  }
];
...
export default function App() {
  ...
  const [userProfileName, setUserProfileName] = useState('Madina Abdurahmonova');
  const [userProfileAvatar, setUserProfileAvatar] = useState('https://images.unsplash.com/photo-1518791841217-8f162f1e1131?auto=format&fit=crop&w=200&q=80');
  const [userProfileEmail, setUserProfileEmail] = useState('madina.abdurahmonova@gmail.com');
  const [userProfilePhone, setUserProfilePhone] = useState('+998 90 123 45 67');
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      const nextSlide = (activeSlide + 1) % SWIPER_DATA.length;
  ...
  const renderCategoryIcon = (category) => {
    ...
    const filteredSections = CAT_SECTIONS.filter(section => {
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.cardsScrollContainer}>
                {RECOMMENDED_LISTINGS.map((listing) => (
                  <TouchableOpacity key={listing.id} style={styles.animalCard} activeOpacity={0.9}
                    onPress={() => { setSelectedListing(listing); setDetailActiveImageIndex(0); }}>
                  ...
                  {sortedListings.map((item) => {
                    ...
                    return (
                      <TouchableOpacity key={item.id} style={styles.listingsItemCard} activeOpacity={0.9}
                        onPress={() => { setSelectedListing(item); setDetailActiveImageIndex(0); }}>
            ...
            <View style={styles.addModalContent}>
              ...
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
                ...
                <View style={[styles.editProfileTextInput, styles.editProfileTextInputDisabled]}>
                  <Text style={styles.editProfileTextDisabled}>+998 90 123 45 67</Text>
        ...
        >
          {screen === 'welcome' && (
            ...
            <View style={styles.welcomeContent}>
              <TouchableOpacity style={styles.button} activeOpacity={0.85} onPress={() => navigateTo('login')}>
          ...
          {screen === 'login' && (
            ...
            >
              ...
              <View style={[styles.inputContainer, isPhoneFocused && styles.inputFocused]}>
                ...
                {showLoginPrefix && <Text style={styles.phonePrefix}>+998 </Text>}
                <TextInput
              ...
              <TouchableOpacity style={styles.socialButton} activeOpacity={0.85} onPress={() => navigateTo('dashboard')}>
                <Image 
                  source={require('./assets/apple_logo.png')} 
                  style={styles.socialLogo} 
                />
                <Text style={styles.socialButtonText}>Apple orqali kirish</Text>
              </TouchableOpacity>
          ...
          {screen === 'register' && (
            ...
            >
              ...
              {/* Phone Input */}
              <View style={[styles.inputContainer, isRegPhoneFocused && styles.inputFocused]}>
                <Feather name="phone" size={20} color={isRegPhoneFocused ? '#3C8E2D' : '#7C8A79'} style={styles.inputIcon} />
                {showRegPrefix && <Text style={styles.phonePrefix}>+998 </Text>}
                <TextInput
                  style={styles.textInput}
                  placeholder={showRegPrefix ? "" : "Telefon raqam"}
                  placeholderTextColor="#A3B1A0"
                  keyboardType="phone-pad"
                  maxLength={7}
                  value={regPhone}
                  onChangeText={handleRegPhoneChange}
                  onFocus={() => setIsRegPhoneFocused(true)}
                  onBlur={() => setIsRegPhoneFocused(false)}
                />
              </View>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  placeholderTextColor="#A3B1A0"
                  secureTextEntry={regConfirmSecureText}
                  value={regConfirmPassword}
                  onChangeText={setRegConfirmPassword}
                />
                <TouchableOpacity onPress={() => setRegConfirmSecureText(!regConfirmSecureText)}>
                  <Feather
                    name={regConfirmSecureText ? 'eye-off' : 'eye'}
                    size={20}
                    color="#7C8A79"
                    style={styles.eyeIcon}
                  />
